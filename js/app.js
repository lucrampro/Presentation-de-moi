...
TweenMax.to(".trais",0.3,{top:"20%", height:"0"});
TweenMax.to(".trais2",0.3,{top:"40%", height:"0"});
TweenMax.to(".trais3",0.3,{top:"60%", height:"0"});
TweenMax.to(".trais4",0.3,{top:"80%", height:"0"});
TweenMax.to(".trais5",0.3,{top:"100%", height:"0", onComplete:function(){
//    LES VOLET S'OUVRE
    TweenMax.to(".volet",0.5,{width:"0"});
    TweenMax.to(".volet2",0.5,{width:"0"});
